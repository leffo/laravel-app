<template>
    <div class="row mt-5">
        <div class="col-12 p-3">
            ...
            <div class="mt-3">
                <span class="badge bg-danger">{{ article.statstic.views }} <i class="far fa-eye"></i></span>
                <span class="badge bg-primary">{{ article.statstic.likes }} <i class="far fa-thumbs-up"></i></span>
            </div>
        </div>
    </div>
</template>
